...
ns=${BENCH_N_VALUES:-"10 20 30 40 50"}
# max_mem_gb=${BENCH_MAX_MEM_GB:-300}
...
parallel --progress --eta --no-notice --joblog output/joblog --resume --timeout 3600 -j$n_cores benchone {1} {2} {4} \
